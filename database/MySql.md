...
**B+树本质上是一棵按照索引列的值从小到大排列的多路搜索树**，查找的过程就是不断地和节点的“分界值”比较大小，逐层缩小范围，最终定位到叶子节点。
...
我们以一个转账系统为例，从最差的“裸奔”状态开始，逐级递进，看看每个级别解决了什么，又留下了什么坑。
...
<img src="/imgs/undo log版本链.png" alt="undo log版本链" style="zoom:100%;" />
